...
**paymentIntentId** | **string** | PayMongo Payment Intent ID for QR Ph payments | [default to undefined]
**paymongoLinkUrl** | **object** | PayMongo payment link URL (deprecated) | [optional] [default to undefined]
...
```typescript
import { CurrentQrCodeResponseDto } from './api';

const instance: CurrentQrCodeResponseDto = {
    id,
    eventId,
    sessionId,
    paymentId,
